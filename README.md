...
- **Dynamic Interactivity:** Implementation of **JavaScript** to enhance user experience through DOM manipulation and click events.
...
└── src/
    ...
    ├── fonts/          # Local fonts (Inter, Lato)
    ├── imgs/           # Visual resources and photography
